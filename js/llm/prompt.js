...
- You have access to web_search tool. Use it efficiently.
- Combine related terms into a single query when possible.
- Do not search indefinitely.
- If specific details remain unverified, mark those claims as UNVERIFIABLE.
